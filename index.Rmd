...
```
  \
  \
The graduation rates of homeless and low-income students, in contrast to the graduation rates of students not in those groups, both fall below the overall graduation rate of `r round(all_students_grad_rate*100, 2)`%. 
...
```
  \
  \
While some students who do not graduate do enroll in the next academic year, the majority of students who do not graduate drop out. More specifically, 31.6% of homeless students and 18.7% of low-income students in Washington who enroll in high school end up dropping out. 
